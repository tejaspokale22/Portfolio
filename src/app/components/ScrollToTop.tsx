...
export default function ScrollToTop() {
  ...
  return (
    <div
      ...
      title="Scroll to Top"
      className={[
        "fixed bottom-6 left-6 z-50 p-5 rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
        "bg-black/10 dark:bg-white/15 hover:bg-black/15 dark:hover:bg-white/20",
        "flex items-center justify-center cursor-pointer",
        "transform transition-all duration-200 ease-out motion-reduce:transition-none backdrop-blur-md",
        isVisible
